    ...
    <PageSection variant="default"
        ...
        <PageSectionContent>
            <ArticleParagraph title=""
                              faIcon=""
                              :description="[
                                  `This Privacy Policy has been crafted to explain how the information you provide while on YiHaoFastener.com is collected, stored, used, and managed.`,
                                  `When you access YiHaoFastener.com, you are consenting to the collection and use of your personal information as described in this Privacy Policy. Please note that this Policy may be updated periodically, and it's advised for you to check this page frequently for any modifications.`
                              ]"/>

            <ArticleParagraph title="Collected Information"
                              faIcon="fa-solid fa-database"
                              :description="[
                                  `The information that you voluntarily provide may be collected and stored when YiHaoFastener.com is accessed. This may include image files saved on your device storage, usage information such as preferences, purchase history, and/or session duration.`,
            ...
            <ArticleParagraph title="Links"
                              ...
                              :description="[
                                  ...
                                  `It should be made clear that the privacy policies of other websites that may be accessed from YiHaoFastener.com are not our responsibility. Therefore, it is highly recommended that the privacy policies of such websites or apps be read carefully before exiting the application.`
                              ]"/>
        </PageSectionContent>
    </PageSection>
</template>
